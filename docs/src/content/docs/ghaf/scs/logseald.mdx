...
settings, log workload and retention consistent. Disabling FSS removes its forced
audit enablement; the selected platform profile must enable auditing separately
if it is required for the comparison.
